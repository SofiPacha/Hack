...
@Component({
  ...
  standalone: true,
  imports: [IGX_EXPANSION_PANEL_DIRECTIVES, IGX_ACCORDION_DIRECTIVES, IGX_CHIPS_DIRECTIVES, IGX_LIST_DIRECTIVES, IgcFormsModule, IgxAvatarComponent, IgxIconComponent, FormsModule, FormsModule],
