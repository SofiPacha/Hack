...
@Component({
  ...
  standalone: true,
  imports: [IGX_CHIPS_DIRECTIVES, IGX_CARD_DIRECTIVES, IGX_LIST_DIRECTIVES, IgxToggleActionDirective, IgxOverlayOutletDirective, IgxIconButtonDirective, IgxButtonDirective, IgxRippleDirective, IgxToggleDirective, IgxIconComponent, IgxAvatarComponent, IgcFormsModule, IgxCheckboxComponent, RouterLink, FormsModule, FormsModule],
